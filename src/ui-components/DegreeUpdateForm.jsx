...
export default function DegreeUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = degreeRecord
      ? { ...initialValues, ...degreeRecord, educationID, School }
      : initialValues;
  ...
  React.useEffect(() => {
    const queryData = async () => {
      ...
      const SchoolRecord = record ? await record.School : undefined;
      setSchool(SchoolRecord);
    };
    queryData();
  }, [idProp, degreeModelProp]);
  React.useEffect(resetStateValues, [degreeRecord, educationID, School]);
        ...
        try {
          ...
          await DataStore.save(
            Degree.copyOf(degreeRecord, (updated) => {
              ...
              if (!modelFields.School) {
                updated.schoolID = undefined;
              }
            })
          );
          if (onSuccess) {
